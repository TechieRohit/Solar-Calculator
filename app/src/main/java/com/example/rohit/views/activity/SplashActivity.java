...
public class SplashActivity extends AppCompatActivity implements
    ...
    /**
     * Getting the mandatory permissions at the runtime
     * in order to smoothly run the application
     */
    ...
    public void startActivity() {
        ...
        intent.putExtra(IntentKeys.CURRENT_PLACE_LATITUDE,mLastLocation.getLatitude());
        intent.putExtra(IntentKeys.CURRENT_PLACE_LONGITUDE,mLastLocation.getLongitude());
